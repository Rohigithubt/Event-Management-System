...
const WebinarList = () => {
  ...
  const renderWebinarCard = useCallback((webinar) => {
    ...
    return (
      <div
        key={webinar._id}
        className={`border border-gray-300 rounded-lg p-7 bg-white transition relative ${isExpired ? "opacity-50" : ""
          }`}
      >
        {isExpired && (
        ...
        <div className="absolute top-58 right-4 flex gap-2">
          <button
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="flex-1">
            ...
            <button
              className={`w-full md:w-48 mt-3 px-4 py-2 rounded-3xl text-sm font-medium ${isExpired
